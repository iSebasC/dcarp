        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Listado de Órdenes de Trabajo</h4>
            </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2 pt-xs-1 pl-xs-2">
                      <div class="content-buttons btn-group">
                        ...
                        <!-- <button type="button" @click="excel" class="btn btn-sm btn-success mb-1" title="Exportar a Excel">
                ...
                <table class="table mb-0">
                  ...
                  <tbody>
                    ...
                    <tr
                      ...
                      :key="p.id"
                      :class="p.situacion == 'A' ? 'table-danger' : ''"
                    >
                      <td
                        class="text-left"
                        v-text="
                      ...
                      <td class="text-center">
                        <span
                          ...
                          v-text="p.situacion == 'A' ? 'Anulado' : 'Vigente'"
                        ></span>
                      </td>
                      <td class="text-center">
                        <span
                      ...
                      <td class="text-center">
                        <div class="content-buttons btn-group">
                          ...
                          >
                            <i
                              class="mdi mdi-open-in-new icon-size"
                            ></i>
                          </button>
                          ...
                          <!-- <button @click="llenarCheckListM(p.id,p.documento,p.cliente, p.placa)" title="Check List de Manejo" 
                                        class="btn btn-sm btn-success">
                                          <i class="la la-tachometer-alt icon-size"></i>
                                        </button> -->
                          ...
                          <button
                            ...
                            "
                            title="Check List de Taller"
                            class="btn btn-sm btn-success"
                          >
                            <i class="mdi mdi-book-edit-outline icon-size"></i>
                          </button>

                          <button
                            @click="verCheckList(p.id)"
                            title="Ver Check List de Inventario"
                          ...
                          <button
                            @click="verReporteCotizaciones(p.id)"
                          ...
                          <!-- <button @click="verCheckListCalidad(p.id)" title="Ver Check List de Calidad" class="btn btn-sm btn-link" style="background-color:#fff;">
                                          <i class="mdi mdi-printer-check icon-size"></i>
                                        </button> -->
