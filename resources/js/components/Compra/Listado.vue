    ...
    <div class="content-header row">
      ...
      <div class="content-header-right col-md-6 col-12">
        <div class="btn-group float-md-right" role="group" aria-label="Agregar Compra">
          <router-link tag="a" to="/compra/crear" class="btn btn-info btn-sm btn-rounded box-shadow-2 px-2 mb-1" type="button">
          <i class="mdi mdi-plus icon-size"></i> Agregar Compra</router-link>
        </div>
      </div>
    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 pt-xs-1 pl-xs-2">
                                    <div class="content-buttons btn-group">
                                      ...
                                      <button type="button" @click="excel2" class="btn btn-sm btn-icon btn-primary mb-1" 
                                      title="Exportar a Excel [Isuzu/Chevrolet]"><i class="mdi mdi-file-excel icon-size"></i></button>
                          ...
                          <table class="table mb-0">
                            <thead>
                              <tr>
                                ...
                                <th class="text-center">T. Proveedor</th>
                            ...
                            <tbody>
                                ...
                                <tr v-for="(p, index) in compras" :key="p.id" :class="(p.eliminado=='S'?'table-danger':'')">
                                    ...
                                    <td class="text-center">
                                        ...
                                        v-text="p.tipoProveedor!=''?p.tipoProveedor:'-'"></span>
                                    </td>
                                    ...
                                    <td class="text-center">
                                      <div class="content-buttons btn-group">
                                        ...
                                        <button v-if="p.eliminado=='N'" @click="anular(p.id,p.documento, p.proveedor)" title="Anular Compra" class="btn btn-sm btn-danger">
...
export default {
  ...
  methods: {
    ...
    excel () {
      ...
      window.open(`/excel/compra?doc=${documento}&prov=${proveedor}&flete=${flete}&comp=${comprobante}
      &fechaI=${fechaI}&fechaF=${fechaF}&moneda=${moneda}&tipodoc=${tipoDoc}`,'_blank')
    ...
    excel2 () {
      ...
      window.open(`/excel2/compra?doc=${documento}&prov=${proveedor}&flete=${flete}&comp=${comprobante}
      &fechaI=${fechaI}&fechaF=${fechaF}&moneda=${moneda}&tipodoc=${tipoDoc}`,'_blank')
