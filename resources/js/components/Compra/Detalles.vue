<template>
  <div
    ...
    tabindex="-1"
    role="dialog"
    aria-labelledby="modalDetallesCLabel"
    aria-hidden="true"
  >
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalDetallesCLabel">
            ...
            <table class="table table-striped mb-0">
              ...
              <tbody>
                ...
                <tr
                  v-for="p in detalles"
                  :key="p.id"
                  :class="p.estado == '0' ? 'table-danger' : ''"
                >
                  <td
                    class="text-left"
                    v-text="p.item < 10 ? '0' + p.item : p.item"
                  ></td>
                  <td class="text-center" v-text="p.cantidad"></td>
                  <td class="text-center" v-text="p.descripcion"></td>
                  <td class="text-center" v-text="p.preciocompra"></td>
                  <td class="text-center" v-text="p.precioventa"></td>
                  <td class="text-center" v-text="p.subTotal"></td>
                </tr>
              </tbody>
...
export default {
  ...
  methods: {
    cerrarModal () {
      ...
      $('#modalDetallesC').modal('toggle')
      $('#modalDetallesC').css('z-index', '-1')
    ...
    async showModal(attr) {
      ...
      if (me.id > 0) {
        ...
        $("#modalDetallesC").modal({ backdrop: "static", show: true, keyboard: false });
        $("#modalDetallesC").css("z-index", "1500");
