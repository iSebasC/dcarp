<template>
    <div class="content-wrapper" :id="'sec_'+entidad">
            ...
            <div class="content-header-left col-md-6 col-12 mb-2">
                <div class="row breadcrumbs-top d-block">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{accion}} Venta
                        </li>
                    </ol>
                    </div>
                </div>
                <h4 class="content-header-title mb-0 mt-1">{{accion}} Venta</h4>
            </div>
        </div>
                    ...
                    <div class="col-md-11 col-xs-12">
                        <div class="card">
                            <!-- <div class="card-header pb-1">
                                ...
                                <i class="la la-money-check-alt"></i> Datos de la Venta</h4>
                            </div> -->
                                    ...
                                    action="/guardarventa">
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-4 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" :id="'fecha_'+entidad" class="form-control form-control-sm text-center" name="fecha" readonly="">
                                                            </div>
                                                        </div>
                                                        
                                                        <div class="col-md-6 col-xs-12">
                                                            <label :for="'select_tipodocumento_'+entidad">Tipo de Comprobante <span class="text-danger">*</span></label>
                                                            <select class="custom-select custom-select-sm" name="tipodocumento" :id="'select_tipodocumento_'+entidad" 
                                                            @change="tipoVenta" v-model="tipoComprobante">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                name="documento" maxlength="11" minlength="8" @keypress="soloNumeros($event)" 
                                                                @keyup.enter="busquedaCliente">
                                                            </div>
                                                        </div>
                                                        
                                                        <div class="col-md-2 col-xs-12">
                                                            <div class="content-buttons btn-group-vertical my-md-3 pt-2">
                                                                ...
                                                                <button v-if="bandCliente02" @click="verCliente" title="Ver Cliente"
                                                                 class="btn btn-sm btn-warning" type="button">
                                                                    <i class="mdi mdi-file-eye icon-size"></i>
                                                                </button>
                                                                <button @click="editarCotOrden" title="Editar Cotizaciones/Orden de Trabajo"
                                                                 class="btn btn-sm btn-primary" type="button">
                                                                    <i class="mdi mdi-pencil icon-size"></i>
                                                                </button>
                                                                <button v-if="bandCliente" @click="agregarCliente" title="Buscar Cliente" 
                                                        ...
                                                        <div class="col-md-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div id="bq">
                                                                    <input class="mr-1 mt-1 chk" type="radio" :checked="tipoVentaV=='P'" 
                                                                    @change="seleccionarTipoVenta('P')" :disabled="campoBloqueado"
                                                                    name="chkTipoVenta">Producto/Servicio
                                                                    <br>
                                                                    <input class="mr-1 mt-1 chk" type="radio" :checked="tipoVentaV=='C'"
                                                                    @change="seleccionarTipoVenta('C')" :disabled="campoBloqueado"
                                                                    name="chkTipoVenta">Cotización
                                                                    <br>
                                                                    <input class="mr-1 mt-1 chk" type="radio"  :checked="tipoVentaV=='O'"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5 col-xs-12">
                                                            <label :for="'select_serie_'+entidad">Serie <span class="text-danger">*</span></label>
                                                            <select class="custom-select custom-select-sm" :id="'select_serie_'+entidad" name="serie" :disabled="bloqueo_serie_combo">
                                                                <option value="" disabled="" selected="">Seleccione</option>
                                                                <option v-for="f in series" :key="f.id" :value="f.id"> {{f.serie}}</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-5 col-xs-12">
                                                            <label :for="'select_tipo_operacion_'+entidad">Método de Pago <span class="text-danger">*</span></label>
                                                            <select class="custom-select custom-select-sm" :disabled="tipoComprobante != 'F'" :id="'select_tipo_operacion_'+entidad" v-model="metodoPago" name="tipopago">
                                                                <!-- <option value="" disabled="" selected="">Seleccione</option> -->
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-3 col-xs-12" v-if="metodoPago == 'D' && tipoComprobante == 'F'">
                                                            <div class="form-group">
                                                                <label :for="'nrodias_'+entidad">Nro Días <span class="text-danger">*</span></label>
                                                                <input type="text" :id="'nrodias_'+entidad" maxlength="2" @keypress="soloNumeros($event);" v-model="nroDias" name="nrodias" 
                                                                class="form-control form-control-sm">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 col-xs-12">
                                                            <label :for="'select_forma_pago_'+entidad">Forma de Pago <span class="text-danger">*</span></label>
                                                            <select class="custom-select custom-select-sm"  :id="'select_forma_pago_'+entidad" name="formapago">
                                                                <!-- <option value="" disabled="" selected="">Seleccione</option> -->
                                                                <option v-for="f in tipoPago" :key="f.id" :value="f.id"> {{f.nombre}}</option>
                                                            </select>
                                                        </div>
                                                       <div class="col-md-4 col-xs-12">
                                                            <label :for="'select_igv_'+entidad">Tipo Venta <span class="text-danger">*</span></label>
                                                            <select class="custom-select custom-select-sm" :id="'select_igv_'+entidad" @change="validIgv()" v-model="afectoIgv" name="tipoIgvVenta">
                                                                <!-- <option value="" disabled="" selected="">Seleccione</option> -->
                                                                <option v-for="f in tipoIgvVenta" :key="f.id" :value="f.id"> {{f.nombre}}</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-5 col-xs-12">
                                                            ...
                                                            <select class="custom-select custom-select-sm" :id="'select_moneda_'+entidad" :disabled="detalles.length > 0" v-model="moneda_s" name="monedaVenta">
                                                                <!-- <option value="" disabled="" selected="">Seleccione</option> -->
                                                        ...
                                                        <div class="col-md-5 col-xs-12">
                                                            <label :for="'observacion_'+entidad">Observaciones <small class="small text-muted">(Opcional)</small></label>
                                                            <textarea name="observaciones" class="form-control form-control-sm no-resize" :id="'observacion_'+entidad" rows="2"></textarea>
                                                        </div>
                                                    ...
                                                    <div class="row mt-1">
                                                        <div class="col-md-5 col-xs-12">
                                                            <input class="mr_p-0" type="checkbox" name="chkcaja" value="true" :id="'chk_caja_'+entidad" :checked="chkCaja">
                                                            <label class="text-muted" :for="'chk_caja_'+entidad">Enviar a caja maestra</label>
                                                        </div>
                                                
                                                    </div>
                                                </div>

                                                <div v-if="tipoVentaV=='C'" class="col-md-6 col-xs-12" 
                                                :id="'sec_cotizacion_'+entidad">
                                                    <div class="row">
                                                        <div class="col-md-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                name="descripcion" autocomplete="off"  placeholder="1-8596" @keypress="soloNumerosGuion($event)" 
                                                                @keyup.enter="cargarProductos()" maxlength="13">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="table-responsive px-1" style="width:98%;height:300px;margin 2rem auto;" id="tabla-orden">
                                                            ...
                                                            <table class="table table-bordered table-sm mb-0" id="tabla" style="border: 1px solid #fff;">
                                                                <thead style="background: #081331; color: #fff;">
                                                                    <tr>
                                                                        <th class="text-center">Número/Placa</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr v-for="(p, index) in arrOrdenes" :key="index">
                                                                        <td class="text-center" v-text="p.numero+'/'+p.placa" @click="capturarCotizacion(p.id)"></td>
                                                                        <td class="text-right" style="width:30px;" v-text="p.total2" @click="capturarCotizacion(p.id)"></td>
                                                                        <td class="text-right"  style="width:30px;" v-text="p.fecha" @click="capturarCotizacion(p.id)"></td>
                                                ...
                                                <div v-if="tipoVentaV=='O'" class="col-md-6 col-xs-12" 
                                                :id="'sec_orden_'+entidad">
                                                    <div class="row">
                                                        <div class="col-md-6 col-xs-12">
                                                            <div class="form-group">
                                                                <label :for="'descripcion_'+entidad">Nro de Orden de Trabajo <span class="text-danger">*</span></label>
                                                                <input type="text" :id="'descripcion_'+entidad" class="form-control form-control-sm" 
                                                                name="descripcion"  placeholder="1-8596" autocomplete="off" @keypress="soloNumerosGuion($event)" 
                                                                @keyup.enter="cargarProductos" maxlength="13">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="table-responsive px-1" style="width:98%;height:300px;margin 2rem auto;" id="tabla-orden">
                                                            <small><strong>Seleccione Órdenes para Agregar <span class="text-danger">*</span></strong></small>
                                                            <table class="table table-bordered table-sm mb-0" id="tabla" style="border: 1px solid #fff;">
                                                                <thead style="background: #081331; color: #fff;">
                                                                    <tr>
                                                                        <th class="text-center">Número/Placa</th>
                                                                ...
                                                                <tbody>
                                                                    <tr v-if="!arrOrdenesT.length">
                                                                    <td class="text-left text-danger" colspan="4" rowspan="2"><strong>No se Encontraron Resultados en su Búsqueda</strong></td>
                                                                    </tr>

                                                                    <tr v-for="(p, index) in arrOrdenesT" :key="index">
                                                                        <td class="text-center" v-text="p.numero+'/'+p.placa" @click="capturarOrden(p.id)"></td>
                                                                        <td class="text-right" style="width:30px;" v-text="p.total2" @click="capturarOrden(p.id)"></td>
                                                                        <td class="text-right"  style="width:30px;" v-text="p.fecha" @click="capturarOrden(p.id)"></td>
                                                                        <!--<td class="text-right" style="width:30px;" v-text="p.tiempo"></td>-->
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                ...
                                                <div v-if="tipoVentaV=='P'" class="col-md-6 col-xs-12"
                                                 :id="'sec_producto_'+entidad">
                                                    <div class="row">
                                                        <div class="col-md-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" :id="'descripcion_'+entidad" class="form-control form-control-sm" 
                                                                name="descripcion" maxlength="255" autocomplete="off" @keyup.enter="cargarProductos">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" :id="'cantidad_'+entidad" class="form-control form-control-sm text-center"
                                                                 name="cantidad" min="0.01" step="0.01" value="1" @keyup.enter="agregarDetalle">
                                                            </div>
                                                        </div>

                                                        <div class="col-md-2 col-xs-12">
                                                            <div class="content-buttons btn-group " style="margin-top:1.8rem;">
                                                                 <button @click="cargarProductos" title="Buscar Producto" class="btn btn-sm btn-info" 
                                                                type="button" style="margin-right:3px;">
                                                                    <i class="mdi mdi-magnify icon-size"></i>
                                                                </button>

                                                                <button @click="agregarDetalle" title="Agregar Detalle" 
                                                                class="btn btn-sm btn-danger" type="button">
                                                                    <i class="mdi mdi-plus icon-size"></i>
                                                                </button>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="table-responsive" style="width:100%;height:300px; padding-left:5px; overflow-x:hidden;" id="tabla-cotizacion">
                                                                <table class="table table-bordered table-sm mb-0" id="tabla" style="border: 1px solid #f2f2f2; overflow:hidden scroll;">
                                                                    <thead style="background: #275EE5; color: #fff;">
                                                                    <tr>
                                                                        <th class="text-center" width="15%" style="vertical-align:middle;" rowspan="2">Tipo</th>
                                                                        <th class="text-center" width="45%" style="vertical-align:middle;" rowspan="2">Descripción</th>
                                                                        <th class="text-center" width="40%" colspan="2">Precio</th>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tbody>
                                                                        <tr v-if="!arrProducto.length">
                                                                            <td class="text-left text-danger" width="100%" colspan="4" rowspan="2">
                                                                        ...
                                                                        <tr v-for="(p, index) in arrProducto" :key="index" :class="p.stock == 0 && p.tipo != 'Servicio'?'table-danger':''">
                                                                            <td class="text-center" width="15%" @click="capturarDato(p)"><strong v-text="p.tipo"></strong></td>
                                                                            <td class="text-justify" width="45%" @click="capturarDato(p)">
                                                                                <p  v-text="(p.nombre != ''?(p.nombre+(p.medida != '-'?', Medida: '+p.medida:'')+(p.tipollanta != '-'?', Tipo de Llanta: '+p.tipollanta:'')+(p.modelo != '-'?', Modelo: '+p.modelo:'')+(p.sistema != '-'?' , Sistema: '+p.sistema:'')):p.nombre2)" >
                                                                                </p>
                                                                            </td>
                                                                            <td class="text-center" width="20%" v-text="p.precioS" @click="capturarDato(p)"></td>
                                                                            <td class="text-center" width="20%" v-text="p.precioD" @click="capturarDato(p)"></td>
                                                                            <!--<td class="text-right" style="width:30px;" v-text="p.tiempo"></td>-->
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                            ...
                                            <hr>
                                            <div class="row">
                                                <input type="hidden" name="listOrdenes" :id="'listOrdenes_'+entidad" :value="listOrdenes.join(',')" />
                                                <input type="hidden" name="listCotizaciones" :id="'listCotizaciones_'+entidad" :value="listCotizaciones.join(',')" />
                                                ...
                                                <input type="hidden" name="tipoVenta" :value="tipoVentaV">  
                                              
                                        
                                                <div class="table-responsive px-1" id="tabla-venta-crear" style="height:350px; overflow-y:scroll;">
                                                    <table class="table table-sm mb-0">
                                                        ...
                                                        <tbody style="height:250px;">
                                                            <tr v-for="(p, index) in detalles" :key="p.id">
                                                                ...
                                                                <td style="width:60px;" class="text-center px-1">
                                                                    <input type="number" v-focus-on-create step="0.01" :max="p.stockMax" class="form-control form-control-sm text-right" :name="'txtcantidad'+p.id" :id="'txtcantidad'+p.id" :value="p.cantidad" min="0.01" @keyup.enter="calcularTotalItem(p.id)" @change="calcularTotalItem(p.id)"/>
                                                                </td>
                                                                <td style="width:280px;" class="text-center">
                                                                    <textarea type="text" maxlength="495" style="resize:none;" class="form-control form-control-sm no-resize" :name="'txtproducto'+p.id" :id="'txtproducto'+p.id" v-text="p.descripcion" @change="calcularTotalItem(p.id)"></textarea>
                                                                    <input type="hidden" class="form-control input-md" :name="'productoid'+p.id" :id="'productoid'+p.id" :value="p.idP"/>
                                                                </td>
                                                                <td style="width:50px;" class="text-center px-1">
                                                                    <input type="number" step="0.01" class="form-control form-control-sm text-right" 
                                                                    :name="'txtprecio'+p.id" min="0" :id="'txtprecio'+p.id" :value="p.precio" @keyup.enter="calcularTotalItem(p.id)" @change="calcularTotalItem(p.id)"/>
                                                                
                                                                    <input type="hidden" :name="'stock'+p.id" :id="'stock'+p.id" :value="p.stock" />
                                                                    <input type="hidden" :name="'enlace'+p.id" :id="'enlace'+p.id" :value="p.idEnlace" />
                                                                    <input type="hidden" :name="'tipo'+p.id" :id="'tipo'+p.id" :value="p.tipo" />
                                                                    <input type="hidden" :name="'lote'+p.id" :id="'lote'+p.id" :value="p.lote" />
                                                                    <input type="hidden" :name="'detalle_ref'+p.id" :id="'detalle_ref'+p.id" :value="p.idDetalleRef" />
                                                        ...
                                                        <tfoot class="table-danger">
                                                            <tr>
                                                                <th colspan="2"></th>
                                                                <th>SUB TOTAL: <span v-text="(moneda_s=='PEN'?'S/':'$')"></span> <span class="text-right" v-text="subtotal"></span><input type="hidden" name="subtotalDoc" :value="subtotal"></th>
                                                                <th>IGV: <span v-text="(moneda_s=='PEN'?'S/':'$')"></span> <span class="text-right" v-text="igv"></span><input type="hidden" name="igvDoc" :value="igv"></th>
                                                                <th>TOTAL: <span v-text="(moneda_s=='PEN'?'S/':'$')"></span> <span class="text-right" v-text="total"></span><input type="hidden" name="totalDoc" :value="total"></th>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
                                                </div>
                                        ...
                                        <div class="form-actions ml-1">
                                            <button type="button" @click="enviarFormDetalles(url, entidad, 'VENT')" :id="'btnEnvio_'+entidad" class="btn btn-sm btn-success">
        ...
        <cambiar-orden-cotizacion ref="ordencot"></cambiar-orden-cotizacion>
...
import CambiarOrdenCotizacion from '../CambiarOrdenCotizacion'
export default {
 name: 'MantenimientoVenta',
 mixins: [misMixins],
 components: {
    Cliente,
    CambiarOrdenCotizacion
 },
 data () {
     return {
         accion: 'Registrar',
 ...
 methods: {
    async capturarCotizacion (id) {
        ...
        arreglo.forEach(el => {
            ...
            let elemento = null
            if (el.tipo == 'Servicio') {
                elemento = { id: me.generarCorrelativo(), tipo: el.tipo, 
                    precio:el.precio, descripcion: el.descripcion, stock: el.stock, cantidad: el.cantidad, 
                    stockMax: el.stock, tiempo: 0, idP: el.id, idEnlace: el.id_enlace, idP: el.id, idDetalleRef: el.detalle_ref }
                me.listServicios.push(elemento.id)
            } else {
                elemento = { id: me.generarCorrelativo(), tipo: el.tipo, 
                    precio:el.precio, descripcion: el.descripcion, stock: el.stock, cantidad: el.cantidad, 
                    stockMax: el.stock, tiempo: 0, idP: el.id, idEnlace: el.id_enlace, idP: el.id, lote: el.lote_id, idDetalleRef: el.detalle_ref }
    ...
    async busquedaCliente () {
        ...
        if (val == '') {
            document.getElementById('data-cliente_'+me.entidad).innerHTML = '<div style = "margin-top:10px;"><div class="alert alert-danger text-left alert-dismissible" role="alert"><button type = "button" class="close" data-dismiss = "alert">&times;</button><strong>Seleccione Tipo de Documento Antes de Seguir...</strong></a></div ></div>'
        } else {
    ...
    async cargarProductos () {
        ...
        } else if ( me.tipoVentaV == 'C' ) {
            let descripcion = document.getElementById('descripcion_'+me.entidad).value
            if (me.clienteSeleccionado !=0) {
                let cotizaciones = await axios({
                    method: 'post',
                    url: '/buscarcotizacionesventa', 
                    data: {
                        'descripcion': descripcion,
                ...
                document.getElementById('data-cliente_'+me.entidad).innerHTML = 
                '<div style = "margin-top:10px;"><div class="alert alert-warning text-left alert-dismissible" role="alert"><button type = "button" class="close" data-dismiss = "alert">&times;</button><strong>Indique Cliente para buscar sus Cotizaciones.</strong></a></div ></div>'
             
            }
        } else {
            let descripcion = document.getElementById('descripcion_'+me.entidad).value
            if (me.clienteSeleccionado !=0) {
                let ordenes = await axios({
                    method: 'post',
                    url: '/buscarordenesventa', 
                    data: {
                        'descripcion': descripcion,
                        'clienteId': me.clienteSeleccionado,
                        '_token': this.$store.state.token
                ...
                me.arrOrdenesT = ordenes.data.ordenes
            } else {
                document.getElementById('data-cliente_'+me.entidad).innerHTML = 
                '<div style = "margin-top:10px;"><div class="alert alert-warning text-left alert-dismissible" role="alert"><button type = "button" class="close" data-dismiss = "alert">&times;</button><strong>Indique Cliente para buscar sus Cotizaciones.</strong></a></div ></div>'
    ...
    calcularTotalItem (id) {
        ...
        if (cantidad <= parseFloat(stock)) {
            ...
            document.getElementById('data-stock_'+me.entidad).innerHTML = '<div style = "margin-top:10px;"><div class="alert alert-danger text-left alert-dismissible" role="alert"><button type = "button" class="close" data-dismiss = "alert">&times;</button><strong>Cantidad Indicada No Disponible</strong></a></div ></div>'
        }
    ...
    eliminarDetalles(elem) {
        ...
        } else if (elem.tipo == 'Producto') {
            let ref = `${elem.idP}@${elem.lote}`
            let idx = me.listProductos.indexOf(ref)
            if (idx != -1) {
                me.listProductos.splice(idx, 1)
            }
        }
    },
    eliminar(id) {
    ...
    agregarDetalle() {
        ...
        if (rpta) {
            if (ref.tipo != 'Servicio') {
                ...
                // ref.nombre+(ref.medida != '-'?', Medida: '+ref.medida:'')+(ref.tipollanta != '-'?', Tipo de Llanta: '+ref.tipollanta:'')+(ref.modelo != '-'?', Modelo: '+ref.modelo:'')+(ref.sistema != '-'?' , Sistema: '+ref.sistema:'')
                let moneda = document.getElementById(`select_moneda_${me.entidad}`).value
                ...
                var elemento = { id: me.generarCorrelativo(), tipo: ref.tipo, precio:monto, descripcion: descripcion, stock: ref.stock, cantidad: cantidad, stockMax: me.stockMax, tiempo: ref.tiempo,idP: ref.id, idEnlace: 0, lote: ref.lote_id, idDetalleRef: '' }
                ...
                if (moneda == 'USD') {
                    monto = 0.00
                    document.getElementById('data-stock_'+me.entidad).innerHTML = '<div style = "margin-top:10px;"><div class="alert alert-warning text-left alert-dismissible" role="alert"><button type = "button" class="close" data-dismiss = "alert">&times;</button><strong>Indique precio a Servicio en Dólar</strong></a></div ></div>'
                }
                ...
                var elemento = { id: me.generarCorrelativo(), tipo: ref.tipo, precio:monto, descripcion: descripcion, stock: cantidad, cantidad: cantidad, stockMax: cantidad, tiempo: tot, idP: ref.id, idEnlace: 0, idDetalleRef: ''  }
    ...
    async getSeries (tipo_doc) {
        let response = await axios.get(`/seriesdocumento/${tipo_doc}`)
 ...
 activated: async function () {
    ...
    document.getElementById('select_forma_pago_'+me.entidad).value = 'Efectivo'
