<template>
    <div class="modal fade" id="modalDetallesCot" tabindex="-1" role="dialog" aria-labelledby="modalDetallesCotLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="modalDetallesCotLabel">Detalles de Documento: <strong v-text="this.$attrs.documento"></strong></h5>
                        ...
                        <table class="table table-striped mb-0">
                            ...
                            <tfoot class="table-info">
                                <tr>
                                    ...
                                    <th></th>
                                    <th>TOTAL</th>
                                    <th class="text-right" v-text="tipo+' '+total"></th>
                                </tr>
                            </tfoot>
                          </table>
                        </div>
