          ...
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">
                Reporte de Historial General
              </li>
            </ol>
          </div>
        </div>
        <h4 class="content-header-title mb-0 mt-1">Reporte de Historial General</h4>
        ...
        <div class="col-8">
          <div class="card py-4">
            <!-- <div class="card-header">
              <h4 class="card-title">Reporte de Historial General</h4>
            </div> -->
...
export default {
  ...
  data() {
    return {
      opciones: [],
      arrTipos: [
        { value: "11", label: "Ordenes de Trabajo" },
        { value: "22", label: "Cotizaciones" },
        { value: "33", label: "Post Ventas" },
        { value: "44", label: "Ventas - Vehículos" },
        { value: "55", label: "Citas" },
      ],
      arrProducto: [],
      arrAlmacen: [],
      detalles: [],
      ...
      almacenId: 2,
      tipoId: "",
      entidad: "reporte_cliente_general",
      bandRender: false,
      select_tipo_reporte: "",
    };
  },
  ...
  methods: {
    async exportar() {
      ...
      if (fechaI != "" && fechaF != "" && tipo != "") {
        window.open(
          `/reportecliente/excel?tipo=${tipo}&fechai=${fechaI}&fechaf=${fechaF}`,
          "_blank"
        );
      } else {
      }
