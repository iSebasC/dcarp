            ...
            <div class="content-header-left col-md-6 col-12 mb-2">
                <div class="row breadcrumbs-top d-block">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <router-link tag="a" to="/compraauto">Compras Autos</router-link>
                        </li>
                        <li class="breadcrumb-item active">{{accion}} Compra
                        </li>
                    </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" :id="'formEnv_'+entidad" method="POST" action="/guardarcompraauto">
                                        ...
                                        <div class="form-body">
                                                ...
                                                <div class="col-md-4 col-xs-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6" style="margin-top:30px;">
                                                            <input type="checkbox" name="chkIgv" :id="'chk_igv_'+entidad" @change="isCheckIgv();" :checked="chkIgv">
                                                            <label class="text-muted" :for="'chk_igv_'+entidad"><small>¿Es afecto a igv?</small></label>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-xs-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" :id="'documento_'+entidad" class="form-control form-control-sm" name="documento" 
                                                                maxlength="11" minlength="8" @keypress="soloNumeros($event)" @keyup.enter="busquedaProveedor">
                                                            </div>
                                                        </div>
                                                        
                                                        <div class="col-md-2 col-xs-2">
                                                            <div class="content-buttons btn-group my-md-3 pt-1">
                                                                <button @click="busquedaProveedor" title="Buscar Proveedor" class="btn btn-sm btn-info" type="button" style="margin-top:10px;">
                                                                    <i class="mdi mdi-magnify icon-size"></i>
                                                                </button>
                                                                <button v-if="bandCliente02" @click="verCliente" title="Ver Proveedor" class="btn btn-sm btn-warning" type="button" style="margin-top:10px;">
                                                                    <i class="mdi mdi-file-eye icon-size"></i>
                                                                </button>
                                                                <button v-if="bandCliente" @click="agregarCliente" title="Buscar Proveedor" class="btn btn-sm btn-danger" type="button" style="margin-top:10px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 col-xs-12">
                                                            <div class="form-group">
                                                                <label :for="'cliente_'+entidad">Proveedor <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="custom-select custom-select-sm" name="tipodocumento" :id="'select_tipodocumento_'+entidad" @change="tipoVenta">
                                                        ...
                                                        <div class="col-md-5 col-xs-12">
                                                            <div class="form-group">
                                                                <label :for="'flete_'+entidad">Flete <span class="text-danger">*</span></label>
                                                                <input type="number" :id="'flete_'+entidad" class="form-control form-control-sm text-right" 
                                                                name="flete" :disabled="deshabilitado"  @change="calcularPreciosVenta" 
                                                                @keyup.enter="calcularPreciosVenta" step="0.01" min="0.0" value="0">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7 col-xs-12">
                                                            <div class="form-group">
                                                                <label :for="'refdocumento_'+entidad">Doc. de Referencia <span class="text-danger">*</span></label>
                                                                <input type="text" :id="'refdocumento_'+entidad" class="form-control form-control-sm text-center" 
                                                                name="refdocumento" placeholder="B1-8596"  maxlength="13">
                                                            </div>
                                                        </div>

                                                        <div class="col-md-5 col-xs-12">
                                                            <label :for="'tipoMoneda_'+entidad">Moneda <span class="text-danger">*</span></label>
                                                            <select class="custom-select custom-select-sm" @change="capturarMoneda" name="tipoMoneda" :id="'tipoMoneda_'+entidad">
                                                                <option value="" disabled="" selected="">Seleccione</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7 col-xs-12">
                                                            <div class="form-group">
                                                                <label :for="'fechavencimiento_'+entidad">Fecha de Vencimiento <span class="text-danger">*</span></label>
                                                                <input type="date" :id="'fechavencimiento_'+entidad" class="form-control form-control-sm text-center" name="fechavencimiento">
                                                            </div>
                                                        </div>
                                                   
                                                        <div class="col-md-5 col-xs-12">
                                                            <div class="form-group">
                                                                <label :for="'credito_'+entidad">Días de Crédito <span class="text-danger">*</span></label>
                                                                <input type="number" :id="'credito_'+entidad" min="0" value="0" class="form-control form-control-sm text-right" name="credito">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                maxlength="255" @keyup.enter="cargarProductos">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" :id="'cantidad_'+entidad" class="form-control form-control-sm text-right" name="cantidad" 
                                                                min="1" value="1" step="1" @keyup.enter="agregarDetalle">
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="table-responsive px-1" style="width:98%;height:300px;margin 2rem auto;" id="tabla-compra">
                                                                <table class="table table-bordered table-sm mb-0" id="tabla">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <td class="text-left text-danger" colspan="2"><strong>No se Encontraron Resultados en su Búsqueda</strong></td>
                                                                        </tr>

                                                                        <tr v-for="(p, index) in arrProducto" :key="index">
                                                                            <td class="text-center" @click="capturarDato(p)"><strong v-text="p.tipo"></strong></td>
                                                                            <td class="text-center" v-text="p.nombre" @click="capturarDato(p)"></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>     
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="table-responsive px-1" id="tabla-compra-crear" style="width:98%;height:350px;margin 2rem auto;">
                                                    <table class="table mb-0">
                                                        <thead class="table-info">
                                                            <tr>
                                                                <th class="text-left" style="width:20px;">#</th>
                                                                <th class="text-center" style="width:60px;">Cantidad</th>
                                                                <th class="text-center" style="width:280px;">Auto</th>
                                                        ...
                                                        <tbody style="height:250px;">
                                                            <tr v-for="(p, index) in detalles" :key="index">
                                                                ...
                                                                <td style="width:60px;" class="text-center px-1">
                                                                    ...
                                                                    :name="'txtcantidad'+p.id" :id="'txtcantidad'+p.id" :value="p.cantidad" disabled="" min="1" 
                                                                    @keyup.enter="calcularTotalItem(p.id)" @change="calcularTotalItem(p.id)"/>
                                                                </td>
                                                                <td style="width:280px;" class="text-center">
                                                                    <textarea class="form-control form-control-sm no-resize" disabled=""
                                                                    :name="'txtproducto'+p.id" :id="'txtproducto'+p.id" 
                                                                    v-text="p.descripcion" rows="4"></textarea>
                                                                    <br/>
                                                                    <textarea v-focus-on-create :name="'descripcion_adic'+p.id" 
                                                                    class="form-control form-control-sm no-resize" :id="'descripcion_adic'+p.id" 
                                                                    placeholder="Descripción Adicional" rows="5" @change="calcularTotalItem(p.id)" v-text="p.descripcion_adic"></textarea>
                                                                    <input type="hidden" :name="'productoid'+p.id" :id="'productoid'+p.id" :value="p.idproducto" />
                                                                    <input type="hidden" :name="'tipo'+p.id" :id="'tipo'+p.id" :value="p.tipo" />
                                                                </td>
                                                                <td style="width:50px;" class="text-center px-1">
                                                                    <input type="number" step="0.01" class="form-control form-control-sm text-right" :name="'txtprecio'+p.id" 
                                                                    min="0" :id="'txtprecio'+p.id" placeholder="P. Compra" @keyup.enter="calcularTotalItem(p.id)" 
                                                                    @change="calcularTotalItem(p.id)" @blur="calcularPreciosVenta(p.id);"/>
                                                                </td>
                                                                <td style="width:50px;" class="text-center px-1">
                                                                    <input type="number" step="0.01" class="form-control form-control-sm text-right" 
                                                                    :name="'txtprecioventa'+p.id" min="0" :id="'txtprecioventa'+p.id" :value="p.precioventa" 
                                                                    placeholder="P. Venta">
                                                                </td>
                                                                <td style="width:50px;" class="text-center px-1">
                                                                    ...
                                                                    <input type="hidden" :name="'txtporcentaje'+p.id" :id="'txtporcentaje'+p.id" :value="p.porcentaje" />
                                                                </td>
                                                                
                                                                <td style="width:30px;">
                                                                    <a href="javascript:void(0)" class="btn-danger btn-sm" @click="eliminar(p.id, p.tipo)" title="Eliminar">
                                                        ...
                                                        <tfoot class="table-danger">
                                                            <tr>
                                                                <th colspan="2"></th>
                                                                <th>SUB TOTAL: <span v-text="tipo"></span> <span class="text-right" v-text="subtotal"></span><input type="hidden" name="subtotalDoc" :value="subtotal"></th>
                                                                <th colspan="2">IGV: <span v-text="tipo"></span> <span class="text-right" v-text="igv"></span><input type="hidden" name="igvDoc" :value="igv"></th>
                                                                <th colspan="2">TOTAL: <span v-text="tipo"></span> <span class="text-right" v-text="total"></span><input type="hidden" name="totalDoc" :id="'totalDoc_'+entidad" :value="total"></th>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
                                                </div>     
                                        ...
                                        <div class="form-actions ml-1">
                                            <button type="button" @click="enviarFormDetalles(url, entidad, 'CA')" 
                                            class="btn btn-sm btn-success" :id="'btnEnvio_'+entidad">
...
export default {
 ...
 methods: {
    ...
    async cargarDatos () {
      ...
      document.getElementById(`tipoMoneda_${me.entidad}`).value = ''
      document.getElementById(`documento_${me.entidad}`).value = ''
      document.getElementById(`refdocumento_${me.entidad}`).value = ''
      document.getElementById(`credito_${me.entidad}`).value = ''
      ...
      document.getElementById(`fechavencimiento_${me.entidad}`).value = me.obtenerFechaActual()
            ...
            window.setTimeout( function () {
                if (response.data.estado) {
                    ...
                    if (response.data.proveedor.tipoDocumento == 'PJ') {
                        ...
                        razonSocial = response.data.proveedor.apellidos + ' '+ response.data.proveedor.nombres
                    }
                    ...
                    me.bandCliente = true
                    document.getElementById('cliente_'+me.entidad).value = ''
                    document.getElementById('data-cliente_'+me.entidad).innerHTML = '<div style = "margin-top:10px;"><div class="alert alert-warning text-left alert-dismissible" role="alert"><button type = "button" class="close" data-dismiss = "alert">&times;</button><strong>Proveedor no Registrado, Antes de Seguir Regístrelo.</strong></a></div ></div>'
                }
            }, 500)
        } else {
            document.getElementById('data-cliente_'+me.entidad).innerHTML = '<div style = "margin-top:10px;"><div class="alert alert-warning text-left alert-dismissible" role="alert"><button type = "button" class="close" data-dismiss = "alert">&times;</button><strong>El Documento debe ser DNI o RUC</strong></a></div ></div>'
        }
    },
    ...
    calcularTotalItem (id) {
        ...
        let preciov  = document.getElementById('txtprecioventa'+id).value
        
        let descripcion =  document.getElementById('txtproducto'+id).value
        let descripcion_adic =  document.getElementById('descripcion_adic'+id).value
        ...
        me.detalles.forEach(element => {
            if (element.id == id) {
                ...
                element.precioventa   = preciov
                element.descripcion = descripcion
                element.descripcion_adic = descripcion_adic
            }
        })
        // me.calcularPrecioVenta(id)
        // console.log(me.detalles)
        // me.calcularPreciosVenta(id)
        me.calcularTotal()
        // } else {
    ...
    calcularPrecioVenta (id) {
        let me = this
        let cantidad = parseFloat(document.getElementById('txtcantidad'+id).value)
        let precio  = parseFloat(document.getElementById('txtprecio'+id).value)
        let porcentaje =  parseFloat(document.getElementById('txtporcentaje'+id).value)/100
        let subtotal =  parseFloat(document.getElementById('txtsubtototal'+id).value)
        let total    =  parseFloat(document.getElementById('totalDoc_'+me.entidad).value)
        let totalFlete = parseFloat(document.getElementById('flete_'+me.entidad).value)
        // let stock = document.getElementById('stock'+id).value
    ...
    capturarDato (ref) {
        ...
        // alert(ref.nombre)
        // let id_aleatorio = me.generarAleatorio(me.min,me.max, me.listAutos)
        // let rpta = me.buscarInArray(id_aleatorio, ref.tipo)
        // document.getElementById('data-stock_'+me.entidad).innerHTML = ''
    ...
    agregarDetalle() {
        ...
        if (ref.tipo == 'Auto') {
            for (let i = 0; i < cantidad; i++) {
                ...
                var elemento = {id: id_aleatorio, tipo: ref.tipo, descripcion: ref.nombre, cantidad: 1, precio: 0, 
                                porcentaje: 0, precioventa: 0, idproducto:ref.id, descripcion_adic:'' }
