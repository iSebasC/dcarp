    ...
    <div class="modal fade" id="modalDetalles" tabindex="-1" role="dialog" aria-labelledby="modalDetallesLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="modalDetallesLabel">Detalles de Documento: <strong v-text="this.$attrs.documento"></strong></h5>
                        ...
                        <table class="table table-striped mb-0">
                            ...
                            <tfoot class="table-info">
                                <tr>
                                    ...
                                    <th></th>
                                    <th></th>
                                    <th>TOTAL <span v-text="this.$attrs.moneda"></span> </th>
                ...
                <div class="modal-footer">
                    ...
                    data-dismiss="modal"><i class="mdi mdi-close icon-size"></i> Cerrar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    methods: {
        async showModal (attr) {
            ...
            if (me.id > 0) {
                ...
                method: 'post',
                    url: '/getdetallesanulacion/'+me.id,
                    data: {
                        '_token': me.token
                    }
                })
                ...
                $('#modalDetalles').modal({backdrop: 'static', show: true})
