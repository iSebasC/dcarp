        ...
        <div class="row breadcrumbs-top d-block">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">
                <router-link tag="a" to="/pedidocompra">Pedidos de Compra</router-link>
              </li>
              <li class="breadcrumb-item active">{{ accion }} Pedidos de Compra</li>
            </ol>
          </div>
        </div>
        <h4 class="content-header-title mb-0 mt-1">{{ accion }} Pedidos de Compra</h4>
      </div>
    </div>
              ...
              <div class="card-content collapse show">
                <div class="card-body">
                  ...
                  >
                      ...
                      <div class="row">
                        <div class="col-md-4 col-xs-12">
                          ...
                          <div class="row">
                            <div class="col-md-7 col-xs-12">
                              <div class="form-group">
                                <label :for="'fechaservicio_' + entidad"
                                  >Fecha de Servicio
                                  <span class="text-danger">*</span></label
                                >
                                <input
                                  type="date"
                                  :id="'fechaservicio_' + entidad"
                                  class="
                                    form-control form-control-sm
                                    text-center
                                  "
                    ...
                    <div class="form-actions ml-1 mt-2">
                      <button
                        type="button"
                        @click="enviarFormDetalles(url, entidad, 'PC')"
...
export default {
  name: "MantenimientoPedidoCompra",
  mixins: [misMixins],
  components: {
    Proveedor,
  },
  ...
  methods: {
    ...
    async cargarDatos() {
      ...
      document.getElementById("fechaservicio_" + me.entidad).value =
        me.obtenerFechaActual();
    },
    ...
    async cargarProductos() {
      ...
      let productos = await axios({
        method: "post",
        url: "/obtenerproductospedidoscompra",
        data: {
