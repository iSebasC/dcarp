    ...
    <div class="modal fade" id="modalGaleria" tabindex="-1" role="dialog" aria-labelledby="modalGaleriaLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <form class="form" id="formEnv2" method="POST" action="/guardaravance">
                    <div class="modal-header">
                            <h5 class="modal-title" id="modalGaleriaLabel">Fotos & Videos de Servicio: <strong v-text="servicio"></strong>
                            <br>
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="listMultimedia" :value="fileLoading.join(',')" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-1">
                                <div class="form-group">
                                    <label for="observaciones">Observaciones <span class="text-success">*</span></label>
                                    <textarea id="observaciones" disabled="" class="form-control form-control-sm no-resize" name="observaciones" rows="4" v-text="observaciones"></textarea>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12" id="data-error2">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <!-- <button type="button" @click="enviarFormModalAR('modalGaleria', 'formEnv2','data-error2')" 
                        class="btn btn-success btn-sm" id="btnEnvio">
...
export default {
    ...
    methods: {
        async showModal (id, servicio, placa) {
            ...
            let me = this
            me.id = id
            this.$refs.miDropzone.setOption('url', '/cargarmultimedia/'+me.id)
            ...
            this.$refs.miDropzone.disable()
            $('#modalGaleria').modal({backdrop: 'static', show: true})
